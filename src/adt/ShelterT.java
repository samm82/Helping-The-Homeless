...
public class ShelterT extends LocationT {
	 ...
	 */
	public ShelterT(shelterResT type, String orgName, String shelterName, String facilityName, String progName,
			String address) {
	...
	/**
	 * Returns true if the shelter is a possible match for the user based on shelter
	 * type
	 * 
	 * @param user The user
	 * @return
	...
	/**
	 * Checks to see whether the shelter has a capacity greater than zero on a
	 * certain date
	 * 
